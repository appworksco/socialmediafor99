...
// I-check kung mayroon nang naka-submit na form para sa pagdagdag ng schedule
if (isset($_POST["add_schedule"])) {
    ...
    // Dito mo itatawag ang function para magdagdag ng schedule
    // Ito ay depende sa iyong implementation sa CRUDFacade class
    $crudFacade->addSchedule($name, $place, $date);

    // I-redirect ang user sa schedule.php pagkatapos ng pag-add ng schedule
